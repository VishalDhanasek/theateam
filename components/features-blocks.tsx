      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">Unlock a World of Possibilities and Unparalleled Expertise Tailored to Cater to Your Unique Needs, Designed to Drive Your Success.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl  transform transition duration-500 hover:scale-110">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Custom Software Development</h4>
              <p className="text-gray-600 text-center">Whether it's a web app, mobile app, we excel at building custom solutions.</p>
            </div>

            {/* 2nd item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl ransform transition duration-500 hover:scale-110">
              <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                  <rect className="fill-current text-blue-600" width="64" height="64" rx="32" />
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">MVP Development</h4>
              <p className="text-gray-600 text-center">Test your product idea cost-effectively with our MVP development services.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl ransform transition duration-500 hover:scale-110">
              ...
              <p className="text-gray-600 text-center">Our skilled designers create intuitive interfaces that enhance the experience.</p>
            </div>
