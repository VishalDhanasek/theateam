...
<div className="relative ">
    <div className="sticky top-0 h-screen flex flex-col  items-center justify-center bg-gray-100">
    <section className="lg:absolute lg:inset-0">
            <div className="flex flex-col lg:min-h-full lg:flex-row space-y-4 space-y-reverse lg:space-y-0 lg:space-x-20">
                <div className="flex-1 flex items-center order-1 lg:order-none">
                ...
                <div className="flex-1 flex items-center">
                    <img width="512" height="480" src="./illus1.png" alt="Illustration 01" />
                </div>
            </div>
        </section>   
