      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="lg:w-1/2 lg:mx-6   pb-12 md:pb-20">
            ...
            <ul className="flex mb-10 md:order-1 md:ml-0 md:mb-0">
            <li>
              <a
                href="#"
                className="flex justify-center items-center text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out"
                aria-label="LinkedIn"
                target="_blank"
              >
                <svg
